...
class pwgs_vertex_attr{
    ...
    /* KJH
     * TODO : For save & load funcionts,
     * Need to know which thread is running on it
     * and get the attrBuf address corresponding to the worker threads
     *
     * Solution : Just pass the attrBuf when the load is called
     */
